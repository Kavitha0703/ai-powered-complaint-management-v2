            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <button 
                      ...
                      className="w-full bg-transparent hover:bg-slate-800/40 rounded-xl p-3 flex items-center justify-center gap-2 transition-all cursor-pointer text-center text-slate-400 hover:text-white text-xs font-bold mt-2"
                    >
              ...
              {currentView === "install" && (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-extrabold text-white text-xl">{"Install Workplace Hub"}</h4>
