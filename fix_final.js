...
const prefix = `export const APP_URL = "https://ai-powered-complaint-management-v2.vercel.app/";
...
const unescaped = prefix.replace(/\\\\\\\`/g, '\`').replace(/\\\${/g, '${');

const idx = content.indexOf("export const EmailTemplates = {");
fs.writeFileSync('src/lib/EmailTemplates.ts', unescaped + "\n" + content.substring(idx));
