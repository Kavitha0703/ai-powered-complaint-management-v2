const fs = require('fs');
let lines = fs.readFileSync('src/pages/UserPages.tsx', 'utf8').split('\n');
...
// clear lines 1592 to 1636
for (let i = 1591; i <= 1636; i++) {
  lines[i] = "";
}

// insert new cards at 1591
lines[1591] = newCards;

fs.writeFileSync('src/pages/UserPages.tsx', lines.join('\n'));
