  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#020617] flex flex-col md:flex-row font-sans transition-colors duration-350">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#F8FAFC] dark:bg-[#020617] transition-colors duration-350">
        ...
        <div className="fixed bottom-6 right-6 z-40 flex items-center gap-3 font-sans transition-all duration-300">
          
          <button
            onClick={() => setFabContainerExpanded(!fabContainerExpanded)}
            className={`w-10 h-10 rounded-full bg-white dark:bg-[#1E293B] text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 flex items-center justify-center shadow-lg transition-transform duration-300 hover:scale-105 active:scale-95 cursor-pointer z-50 ${fabContainerExpanded ? "rotate-0" : "rotate-180"}`}
